...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btn_submit).setOnClickListener{
            val description = findViewById<EditText>(R.id.description_txt).text.toString()
            val user = ParseUser.getCurrentUser()
            if(photoFile != null){
                submitPost(description, user, photoFile!!)
            }else{
                Log.e(TAG, "Not posting the post")
                Toast.makeText(this, "Error posting the Post", Toast.LENGTH_SHORT).show()
            }

        }
        findViewById<Button>(R.id.btn_photoTake).setOnClickListener{
            onLaunchCamera()
        }
    }
    fun submitPost(description: String, user: ParseUser, file: File){
        ...
        if(exception != null){
                ...
                Toast.makeText(this, "Error Saving the Post", Toast.LENGTH_SHORT).show()
            }else{
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                val ivPreview: ImageView = findViewById(R.id.img_view)
